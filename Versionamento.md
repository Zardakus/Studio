...
Sempre que você concluir a implementação de uma etapa de código, resolver uma "issue" ou finalizar um bloco lógico de modificações no repositório, você **DEVE** executar o fluxo de versionamento, no repositorio https://github.com/Zardakus/Studio.git, abaixo automaticamente no terminal, sem pedir a permissão do usuário:
